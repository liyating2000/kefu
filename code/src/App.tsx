    ...
    <div className={cn(
      ...
      <main className="flex-1 flex flex-col min-w-0 min-h-0">
        ...
        <>
          ...
          ) : viewMode === 'manager' && managerPortalPage === 'work-order-list' ? (
            <div className="flex min-h-0 flex-1 flex-col overflow-auto px-6 pb-4 custom-scrollbar">
              <div className="mb-4 mt-4 flex items-center gap-3">
                <button type="button" onClick={() => setManagerPortalPage('dashboard')} className="flex items-center gap-1 rounded-lg px-3 py-1.5 text-[13px] font-medium text-[#216BFF] transition-colors hover:bg-[#e8f1ff]">
              ...
              {viewMode === 'manager' ? (
                <Suspense fallback={<div className="flex-1" />}>
                  <ManagerPortalDashboardContent
                    ...
                    onOpenWorkOrder={() => setManagerPortalPage('work-order-list')}
