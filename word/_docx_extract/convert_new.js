const fs = require('fs');
const xml = fs.readFileSync('unzipped_new/word/document.xml', 'utf-8');
...
fs.writeFileSync('output_new.md', mdContent, 'utf-8');
fs.writeFileSync('helpDocContent_new.ts', finalContent, 'utf-8');
