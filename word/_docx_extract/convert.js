const fs = require('fs');
const xml = fs.readFileSync('unzipped_v1/word/document.xml', 'utf-8');
...
fs.writeFileSync('output.md', mdContent, 'utf-8');
fs.writeFileSync('helpDocContent.ts', finalContent, 'utf-8');
